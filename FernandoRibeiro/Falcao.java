    ...
    public static void main(String[] args) {
       ...
       Animal falc01 = new Animal ();
        ...
        falc02.setvelocidadeVoo(150);
         ...
         Animal faisao = new Animal();
         
        faisao.setCor("Preto e branco");
        faisao.setnomeCientifico("Lophura nycthemera;");
        faisao.setclasse("Aves");
        faisao.sethabitat("Florestas montanhosas");
        faisao.setnomeComum("Faisão-prateado");
        faisao.setdistribuicao("Sudeste asiático e ilhas do Havaí");
        faisao.setvelocidadeVoo(61);
        ...
        String message03 =  "\nNome Comum: " + faisao.getnomeComum() + "\nCor: " + faisao.getCor() + "\nVelocidade: " + faisao.getvelocidadeVoo()+"km/h" + "\nNome cientifíco: "  + faisao.getnomeCientifico() + "\nClasse: " + faisao.getclasse() + "\nHabitat: " + faisao.gethabitat() + "\nDistribuição: " + faisao.getdistribuicao();
